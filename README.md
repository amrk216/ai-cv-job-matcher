...
Loads the Job Description using job_id.

Downloads the resume from S3.

Extracts the PDF content.

Converts the extracted content into Markdown.

Sends the resume and Job Description to the LLM.

Parses the structured LLM response.

Calculates the candidate decision based on the Job Match Score.

Returns the candidate evaluation to the parent workflow.
